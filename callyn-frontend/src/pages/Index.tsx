  ...
  return (
    <div className="bg-background min-h-screen">
      ...
      <section className="bg-muted/30 py-16 px-4">
        <div className="container mx-auto text-center">
          ...
          <div className="flex flex-col items-center">
            <Button className="rounded-full bg-primary hover:bg-primary/90 text-primary-foreground text-lg py-6 px-8" asChild>
      ...
      <div className="fixed bottom-6 right-6">
        <Button className="h-14 w-14 rounded-full bg-primary hover:bg-primary/90 text-primary-foreground flex items-center justify-center">
